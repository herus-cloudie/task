...
const PriceList = async () => {
  ...
  return (
    <div className="bg-BTC relative mt-20">
        ...
        <div className="z-20 absolute top-5 flex justify-center items-center flex-col w-full">
            ...
            <div className="w-[380px] sm:w-[600px] md:w-[700px] lg:w-[900px] xl:w-[1220px] bg-white p-5 rounded shadow-lg shadow-blue-300">
                <div className="flex justify-between items-center mb-5 font-bold text-2xl">
                    <span className="text-[#4C5254]">نام</span>
                    <span className="text-[#4C5254] -ml-16">قیمت</span>
                ...
                </div>
                {
                    cryptoDetails.map(({ price , change , symbol}) =>{
                        ...
                        return(
                            <div className="flex justify-between items-start py-4 border-t">
                                <span className="text-xl">{symbol}</span>
                                <span className="text-xl text-blue-1">{roundedPrice} $</span>
                                <span className={`${change > 0 ? 'text-green-500' : 'text-red-500'} text-xl`}>{roundedChange} %</span>
                            </div>
                        )
                    }     
                )
