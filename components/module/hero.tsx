...
const Hero = () => {
  return (
    <div className="bg-blue-1 xl:h-[822px] lg:h-[722px] h-[600px] flex justify-center">
        <Header />
        <Image style={{filter : 'invert(1)'}} width={800} height={820} alt="heroBg" className="absolute right-0 opacity-5 z-10" src={'/img/heroBg.svg'}/>
        ...
        <div className="flex flex-col justify-between absolute top-[355px] right-10 md:right-24 sm:top-52 xl:top-60 z-20 gap-8 w-[350px] xl:w-[450px]">
            <div className="text-white flex flex-col justify-between ">
                ...
                <div className="text-gray-300 text-[20px]">مطمین ترین صرافی ارز دیجیتال ایران</div>
            </div>
